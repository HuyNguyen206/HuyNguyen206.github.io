...
@section('content')
    ...
    @include('backend.pages.content-header', ['type'=>'Coupon','action'=>'Thêm coupon'])
    <!-- /.content-header -->
{{--        {{dd($errors->all())}}--}}
        <!-- Main content -->
        <div class="content">
...
{{--                @endif--}}
                <div class="row">
                    <div class="col-12">
                        <form role="form" action="admin/coupon/add" method="post" enctype="multipart/form-data">
                            @csrf
                            <div class="row">
                                <div class="col-12">
                                    <!-- text input -->
                            ...
                            <div class="row">
                                <div class="col-12">
                                    <div class="form-group">
                                        ...
                                        <input name="quantity" type="number" class="form-control @error('quantity') is-invalid @enderror " placeholder="Enter ..." value="{{old('quantity')}}">
                                        @error('quantity')
                                        <div class="invalid-feedback">
                                            {{$message}}
                                        </div>
...
{{--                            </div>--}}
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select name="coupon_type" class="form-control list-categories @error('coupon_type') is-invalid @enderror">
                                            @foreach ($couponTypes as $ct)
                                                <option @if($errors->any() && $ct->id == old('coupon_type')) selected @endif value="{{$ct->id}}"> {{$ct->name}} </option>
                                            @endforeach
                                        </select>
                                        @error('coupon_type')
                                        <div class="invalid-feedback">
                            ...
                            <div class="row">
                                <div class="col-12">
                                    ...
                                    <div class="form-group">
                                        <label>Code</label>
                                        <input name="code" type="text" class="form-control @error('code') is-invalid @enderror " placeholder="Enter ..." value="{{old('code')}}">
                                        @error('code')
                                        <div class="invalid-feedback">
                                            {{$message}}
                                        </div>
                            ...
                            <div class="row">
                                <div class="col-12">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input name="code_value" type="text" class="form-control @error('code_value') is-invalid @enderror " placeholder="Enter ..." value="{{old('code_value')}}">
                                        @error('code')
                                        <div class="invalid-feedback">
                                            {{$message}}
                                        </div>
                            ...
                            <div class="row">
                                <div class="col-3">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input name="start_date" type="date" class="form-control @error('code') is-invalid @enderror " placeholder="Enter ..." value="{{old('start_date')}}">
                                        @error('start_date')
                                        <div class="invalid-feedback">
                                            {{$message}}
                                        </div>
                                ...
                                <div class="col-3">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input name="end_date" type="date" class="form-control @error('end_date') is-invalid @enderror " placeholder="Enter ..." value="{{old('end_date')}}">
                                        @error('end_date')
                                        <div class="invalid-feedback">
                                            {{$message}}
                                        </div>
