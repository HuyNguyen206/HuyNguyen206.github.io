...
<link rel="stylesheet" href="backend/role/add.css">
@endsection
@section('content')
...
{{--                @endif--}}
                <div class="row">
                    <div class="col-12">
                        <form role="form" action="admin/role/add" method="post" enctype="multipart/form-data">
                            @csrf
                            <div class="row">
                                <div class="col-12">
                                    <!-- text input -->
                                ...
                                <div class="col-12">
                                    <div class="form-group">
                                        <div class="form-group">
                                            ...
                                            <textarea name="display_name" class="form-control  @error('display_name') is-invalid @enderror" rows="6"
                                                      placeholder="Enter ...">{{old('display_name')}}</textarea>
                                            @error('display_name')
                                            <div class="invalid-feedback">
                                                {{$message}}
                                            </div>
...
{{--                            @foreach ($permissionArray as $parent)--}}
{{--                                <div class="row">--}}
{{--                                    <div class="col-12">--}}
                                        ...
                                        <div class="card border-primary mb-3">
                                            ...
                                            <div class="row">
                                                @foreach ($parent->childPermission as $child)
                                                    <div class="card-body text-primary col-3">
                                                        <input type="checkbox" name="permission[]" class="action" value="{{$child->id}}">
                                                        <label> {{$child->name}}</label>
                                                    </div>
                                                @endforeach
                                            </div>
...
{{--    <script src="backend/vendors/tinyMCE/tinymce.min.js"></script>--}}
    <script src="backend/role/add.js"></script>
